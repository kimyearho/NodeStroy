...
!function(t){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=t()
    ...
    return function e(t,n,r){function o(s,a){if(!n[s]){if(!t[s]){var c="function"==typeof require&&require
        if(!a&&c)return c(s,!0)
        if(i)return i(s,!0)
        var p=Error("Cannot find module '"+s+"'")
        ...
        e.exports=r,r.priorWebsocketSuccess=!1,s(r.prototype),r.protocol=p.protocol,r.Socket=r,r.Transport=t("./transport"),r.transports=t("./transports"),r.parser=t("engine.io-parser"),r.prototype.createTransport=function(t){a('creating transport "%s"',t)
            ...
            var n=Error("probe error")
            n.transport=u.name,h.emit("upgradeError",n)}}))}function n(){f||(f=!0,p(),u.close(),u=null)}function o(e){var r=Error("probe error: "+e)
        ...
        e.exports=r,i(r.prototype),r.prototype.onError=function(t,e){var n=Error(t)
            return n.type="TransportError",n.description=e,this.emit("error",n),this},r.prototype.open=function(){return("closed"==this.readyState||""==this.readyState)&&(this.readyState="opening",this.doOpen()),this},r.prototype.close=function(){return("opening"==this.readyState||"open"==this.readyState)&&(this.doClose(),this.onClose()),this},r.prototype.send=function(t){if("open"!=this.readyState)throw Error("Transport not open")
        ...
        if(!c)throw Error("JSONP disabled")
        ...
        e&&(this.supportsBinary=!1),this.perMessageDeflate=t.perMessageDeflate,o.call(this,t)}var o=t("../transport"),i=t("engine.io-parser"),s=t("parseqs"),a=t("component-inherit"),c=t("yeast"),p=t("debug")("engine.io-client:websocket"),u=n.WebSocket||n.MozWebSocket,f=u
        if(!f&&"undefined"==typeof window)try{f=t("ws")}catch(h){}e.exports=r,a(r,o),r.prototype.name="websocket",r.prototype.supportsBinary=!0,r.prototype.doOpen=function(){if(this.check()){var t=this.uri(),e=void 0,n={agent:this.agent,perMessageDeflate:this.perMessageDeflate}
        ...
        e.exports=function(t){var e=t.xdomain,n=t.xscheme,o=t.enablesXDR
            try{if("undefined"!=typeof XMLHttpRequest&&(!e||r))return new XMLHttpRequest}catch(i){}try{if("undefined"!=typeof XDomainRequest&&!n&&o)return new XDomainRequest}catch(i){}if(!e)try{return new ActiveXObject("Microsoft.XMLHTTP")}catch(i){}}},{"has-cors":22}],11:[function(t,e,n){function r(t,e,n){function r(t,o){if(r.count<=0)throw Error("after called too many times");--r.count,t?(i=!0,e(t),e=n):0!==r.count||i||e(null,o)}var i=!1
        ...
        for(var e=(t||"").split(/[\s,]+/),r=e.length,o=0;r>o;o++)e[o]&&(t=e[o].replace(/\*/g,".*?"),"-"===t[0]?n.skips.push(RegExp("^"+t.substr(1)+"$")):n.names.push(RegExp("^"+t+"$")))}function s(){n.enable("")}function a(t){var e,r
        ...
        n.encodePacket=function(t,n,i,a){"function"==typeof n&&(a=n,n=!1),"function"==typeof i&&(a=i,i=null)
            ...
            var p=m[t.type]
            return void 0!==t.data&&(p+=i?l.encode(t.data+""):t.data+""),a(""+p)},n.encodeBase64Packet=function(t,r){var o="b"+n.packets[t.type]
            ...
            try{s=String.fromCharCode.apply(null,new Uint8Array(t.data))}catch(a){for(var c=new Uint8Array(t.data),p=Array(c.length),u=0;u<c.length;u++)p[u]=c[u]
            ...
            return+i==i&&b[i]?t.length>1?{type:b[i],data:t.substring(1)}:{type:b[i]}:v}var s=new Uint8Array(t),i=s[0],a=u(t,1)
            ...
            for(var i,s,a="",c=0,p=t.length;p>c;c++){var u=t.charAt(c)
                if(":"!=u)a+=u
                else{if(""==a||a!=(i=+a))return r(v,0,1)
        ...
        return s}function f(){if(v>=b)throw Error("Invalid byte contents")
        var t=255&m[v]
        if(v++,128==(192&t))return 63&t
        throw Error("Invalid continuation byte")}function h(){var t,e,n,r,o
        if(v>b)throw Error("Invalid byte contents")
        if(v==b)return!1
        ...
        return s(n)}var d="object"==typeof r&&r,y="object"==typeof n&&n&&n.exports==d&&n,g="object"==typeof e&&e;(g.global===g||g.window===g)&&(o=g)
        ...
        e.exports=r,r.prototype.emitAll=function(){this.emit.apply(this,arguments)
            ...
            var r=c(e,"open",function(){n.onopen(),t&&t()}),i=c(e,"error",function(e){if(u("connect_error"),n.cleanup(),n.readyState="closed",n.emitAll("connect_error",e),t){var r=Error("Connection error")
        ...
        n.deconstructPacket=function(t){function e(t){if(!t)return t
            if(o(t)){var i={_placeholder:!0,num:n.length}
                return n.push(t),i}if(r(t)){for(var s=Array(t.length),a=0;a<t.length;a++)s[a]=e(t[a])
        ...
        if(n.BINARY_EVENT==e.type||n.BINARY_ACK==e.type){for(var o="";"-"!=t.charAt(++r)&&(o+=t.charAt(r),r!=t.length););if(o!=+o||"-"!=t.charAt(r))throw Error("Illegal attachments")
            e.attachments=+o}if("/"==t.charAt(r+1))for(e.nsp="";++r;){var i=t.charAt(r)
            if(","==i)break
            if(e.nsp+=i,r==t.length)break}else e.nsp="/"
        var s=t.charAt(r+1)
        if(""!==s&&+s==s){for(e.id="";++r;){var i=t.charAt(r)
            if(null==i||+i!=i){--r
                break}if(e.id+=t.charAt(r),r==t.length)break}e.id=+e.id}if(t.charAt(++r))try{e.data=f.parse(t.substr(r))}catch(a){return p()}return u("decoded %s as %j",t,e),e}function c(t){this.reconPack=t,this.buffers=[]}function p(t){return{type:n.ERROR,data:"parser error"}}var u=t("debug")("socket.io-parser"),f=t("json3"),h=(t("isarray"),t("component-emitter")),l=t("./binary"),d=t("./is-buffer")
        n.protocol=4,n.types=["CONNECT","DISCONNECT","EVENT","BINARY_EVENT","ACK","BINARY_ACK","ERROR"],n.CONNECT=0,n.DISCONNECT=1,n.EVENT=2,n.ACK=3,n.ERROR=4,n.BINARY_EVENT=5,n.BINARY_ACK=6,n.Encoder=r,n.Decoder=s,r.prototype.encode=function(t,e){if(u("encoding packet %j",t),n.BINARY_EVENT==t.type||n.BINARY_ACK==t.type)i(t,e)
            ...
            else{if(!d(t)&&!t.base64)throw Error("Unknown type: "+t)
        ...
        var o
        if("bug-string-char-contents"==t)o="a"!="a"[0]
        ...
        try{v=-109252==v.getUTCFullYear()&&0===v.getUTCMonth()&&1===v.getUTCDate()&&10==v.getUTCHours()&&37==v.getUTCMinutes()&&6==v.getUTCSeconds()&&708==v.getUTCMilliseconds()}catch(w){}if(!n("json")){var k="[object Function]",x="[object Date]",A="[object Number]",B="[object String]",C="[object Array]",S="[object Boolean]",E=n("bug-string-char-contents")
            ...
            if((d=m.hasOwnProperty)||(d=function(t){var e,n={}
                    ...
                    return n=r=null,i?y=2==i?function(t,e){var n,r={},o=b.call(t)==k
                        ...
                        for(o=r.length;n=r[--o];a.call(t,n)&&e(n));}),y(t,e)},!n("json-stringify")){var j={92:"\\\\",34:'\\"',8:"\\b",12:"\\f",10:"\\n",13:"\\r",9:"\\t"},P="000000",R=function(t,e){return(P+(e||0)).slice(-t)},N="\\u00",D=function(t){for(var e='"',n=0,r=t.length,o=!E||r>10,i=o&&(E?t.split(""):t);r>n;n++){var s=t.charCodeAt(n)
                switch(s){case 8:case 9:case 10:case 12:case 13:case 34:case 92:e+=j[s]
                    break
                    default:if(32>s){e+=N+R(2,s.toString(16))
                        break}e+=o?i[n]:t.charAt(n)}}return e+'"'},U=function(t,e,n,r,o,i,s){var a,c,p,u,h,l,m,v,w,k,E,T,j,P,N,q
                try{a=e[t]}catch(L){}if("object"==typeof a&&a)if(c=b.call(a),c!=x||d.call(a,"toJSON"))"function"==typeof a.toJSON&&(c!=A&&c!=B&&c!=C||d.call(a,"toJSON"))&&(a=a.toJSON(t))
                    ...
                    a=(0>=p||p>=1e4?(0>p?"-":"+")+R(6,0>p?-p:p):R(4,p))+"-"+R(2,u+1)+"-"+R(2,h)+"T"+R(2,m)+":"+R(2,v)+":"+R(2,w)+"."+R(3,k)+"Z"}else a=null
                ...
                if("object"==typeof a){for(P=s.length;P--;)if(s[P]===a)throw f()
                    if(s.push(a),E=[],N=i,i+=o,c==C){for(j=0,P=a.length;P>j;j++)T=U(j,a,n,r,o,i,s),E.push(T===g?"null":T)
                        q=E.length?o?"[\n"+i+E.join(",\n"+i)+"\n"+N+"]":"["+E.join(",")+"]":"[]"}else y(r||a,function(t){var e=U(t,a,n,r,o,i,s)
...
!function(t){"use strict"
    function n(t,n,i,e){t.beginPath(),t.arc(n,i,e,0,p,!1),t.fill()}function i(t,n,i,e,a){t.beginPath(),t.moveTo(n,i),t.lineTo(e,a),t.stroke()}function e(t,i,e,a,o,r,l,s){var h=Math.cos(i*p),c=Math.sin(i*p)
        ...
        for(t.strokeStyle=l,t.lineWidth=r,t.lineCap="round",t.lineJoin="round",t.beginPath(),t.arc(e,a,f,0,p,!1),t.stroke(),s=8;s--;)h=(n+s/8)*p,c=Math.cos(h),u=Math.sin(h),i(t,e+c*v,a+u*v,e+c*d,a+u*d)}function l(t,n,i,e,a,o,r){n/=15e3
        ...
        if(t.strokeStyle=s,t.lineWidth=o,t.lineCap="round",t.lineJoin="round",1>m){if(t.beginPath(),m*=d.length/2-1,h=Math.floor(m),m-=h,h*=2,h+=2,t.moveTo(i+(d[h-2]*(1-m)+d[h]*m)*a,e+(d[h-1]*(1-m)+d[h+1]*m)*a),1>g){for(g*=d.length/2-1,c=Math.floor(g),g-=c,c*=2,c+=2,v=h;v!==c;v+=2)t.lineTo(i+d[v]*a,e+d[v+1]*a)
            ...
            t.lineTo(i+(d[c-2]*(1-g)+d[c]*g)*a,e+(d[c-1]*(1-g)+d[c+1]*g)*a),t.stroke()}1>M&&(M*=d.length/2-1,u=Math.floor(M),M-=u,u*=2,u+=2,f(t,n,i+(d[u-2]*(1-M)+d[u]*M)*a,e+(d[u-1]*(1-M)+d[u+1]*M)*a,a,o,s))}var d,m
    !function(){var n=t.requestAnimationFrame||t.webkitRequestAnimationFrame||t.mozRequestAnimationFrame||t.oRequestAnimationFrame||t.msRequestAnimationFrame,i=t.cancelAnimationFrame||t.webkitCancelAnimationFrame||t.mozCancelAnimationFrame||t.oCancelAnimationFrame||t.msCancelAnimationFrame
        n&&i?(d=function(t,i){function e(){a.value=n(e),t()}var a={value:null}
            return e(),a},m=function(t){i(t.value)}):(d=setInterval,m=clearInterval)}()
    var g=500,M=.08,p=2*Math.PI,C=2/Math.sqrt(2),w=[[-.75,-.18,-.7219,-.1527,-.6971,-.1225,-.6739,-.091,-.6516,-.0588,-.6298,-.0262,-.6083,.0065,-.5868,.0396,-.5643,.0731,-.5372,.1041,-.5033,.1259,-.4662,.1406,-.4275,.1493,-.3881,.153,-.3487,.1526,-.3095,.1488,-.2708,.1421,-.2319,.1342,-.1943,.1217,-.16,.1025,-.129,.0785,-.1012,.0509,-.0764,.0206,-.0547,-.012,-.0378,-.0472,-.0324,-.0857,-.0389,-.1241,-.0546,-.1599,-.0814,-.1876,-.1193,-.1964,-.1582,-.1935,-.1931,-.1769,-.2157,-.1453,-.229,-.1085,-.2327,-.0697,-.224,-.0317,-.2064,.0033,-.1853,.0362,-.1613,.0672,-.135,.0961,-.1051,.1213,-.0706,.1397,-.0332,.1512,.0053,.158,.0442,.1624,.0833,.1636,.1224,.1615,.1613,.1565,.1999,.15,.2378,.1402,.2749,.1279,.3118,.1147,.3487,.1015,.3858,.0892,.4236,.0787,.4621,.0715,.5012,.0702,.5398,.0766,.5768,.089,.6123,.1055,.6466,.1244,.6805,.144,.7147,.163,.75,.18],[-.75,0,-.7033,.0195,-.6569,.0399,-.6104,.06,-.5634,.0789,-.5155,.0954,-.4667,.1089,-.4174,.1206,-.3676,.1299,-.3174,.1365,-.2669,.1398,-.2162,.1391,-.1658,.1347,-.1157,.1271,-.0661,.1169,-.017,.1046,.0316,.0903,.0791,.0728,.1259,.0534,.1723,.0331,.2188,.0129,.2656,-.0064,.3122,-.0263,.3586,-.0466,.4052,-.0665,.4525,-.0847,.5007,-.1002,.5497,-.113,.5991,-.124,.6491,-.1325,.6994,-.138,.75,-.14]],y=[{start:.36,end:.11},{start:.56,end:.16}],b=function(t){this.list=[],this.interval=null,this.color=t&&t.color?t.color:"black",this.resizeClear=!(!t||!t.resizeClear)}
    b.CLEAR_DAY=function(t,n,i){var e=t.canvas.width,a=t.canvas.height,o=Math.min(e,a)
        ...
        v(t,n,.5*e,.5*a,o,o*M,0,2,i),v(t,n,.5*e,.5*a,o,o*M,1,2,i)},b.FOG=function(t,n,e){var a=t.canvas.width,o=t.canvas.height,r=Math.min(a,o),l=r*M
        u(t,n,.5*a,.32*o,.75*r,l,e),n/=5e3
        var s=Math.cos(n*p)*r*.02,h=Math.cos((n+.25)*p)*r*.02,c=Math.cos((n+.5)*p)*r*.02,f=Math.cos((n+.75)*p)*r*.02,v=.936*o,d=Math.floor(v-.5*l)+.5,m=Math.floor(v-2.5*l)+.5
        t.strokeStyle=e,t.lineWidth=l,t.lineCap="round",t.lineJoin="round",i(t,s+.2*a+.5*l,d,h+.8*a-.5*l,d),i(t,c+.2*a+.5*l,m,f+.8*a-.5*l,m)},b.prototype={_determineDrawingFunction:function(t){return"string"==typeof t&&(t=b[t.toUpperCase().replace(/-/g,"_")]||null),t},add:function(t,n){var i
